#!/usr/bin/env python3
"""
import_vocab.py — read vocabulary CSVs (declared in cms/source/manifest.yaml)
...
catalog), not from a hardcoded dict in this file. To add a new lib:
  1. add an entry to cms/source/manifest.yaml's `libs:`
...
def main() -> None:
    ...
    setup_env()
    cfg = load_config()  # noqa: F841 — validates cms/.env
