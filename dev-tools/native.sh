...
#                      Tail .local/main/logs/<svc>.log. Default: both.
...
#
# Lifecycle files (all under repo-root .local/, gitignored):
#   .local/main/pids/backend.pid       .local/main/pids/frontend.pid
#   .local/main/logs/backend.log       .local/main/logs/frontend.log
#
...
PID_DIR="$PROJECT_DIR/.local/main/pids"
LOG_DIR="$PROJECT_DIR/.local/main/logs"
