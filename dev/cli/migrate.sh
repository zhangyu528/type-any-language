#!/bin/bash
#
# dev/cli/migrate.sh — apply pending schema migrations to the dev db.
#
...
#      (or `bash dev/dev migrate` after `docker compose up db`)
#
