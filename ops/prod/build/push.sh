...
#   ./ops/prod/build/push.sh             # interactive
#   ./ops/prod/build/push.sh -y          # CI
#   ./ops/prod/build/push.sh doctor      # check prereqs
#
...
示例:
  ...
  ./ops/prod/build/image.sh && \\
    ./ops/prod/build/push.sh         # 交互
  ./ops/prod/build/push.sh -y        # CI
  ./ops/prod/build/push.sh doctor    # 前置检查
